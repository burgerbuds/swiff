...
function () {
  var _ref = _asyncToGenerator(function* () {
    ...
    const isEnvMissing = localEnv instanceof Error; // Get a summary of any env issues
...
const getEnvIssues = (env, isEnvMissing, isRemoteEnv, requiredSettings = ['ENVIRONMENT', 'DB_SERVER', 'DB_USER', 'DB_PASSWORD', 'DB_DATABASE']) => {
  ...
  const missingSettings = requiredSettings.filter(setting => !(setting in env)); // Return the error if any
